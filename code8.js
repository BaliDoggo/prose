...
gdjs.Level10Code.asyncCallback10594156 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.Level10Code.asyncCallback10594156(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.Level10Code.asyncCallback10595748 = function (runtimeScene, asyncObjectsList) {
...
{
const asyncObjectsList = new gdjs.LongLivedObjectsList();
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.Level10Code.asyncCallback10595748(runtimeScene, asyncObjectsList)));
}
}
...
{
gdjs.Level10Code.condition1IsTrue_0.val = gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().getFromIndex(0)) == 0;
}}
