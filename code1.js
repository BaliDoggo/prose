...
gdjs.Level3Code.asyncCallback10355652 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.Level3Code.asyncCallback10355652(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.Level3Code.mapOfGDgdjs_46Level3Code_46GDplayerObjects1Objects = Hashtable.newFrom({"player": gdjs.Level3Code.GDplayerObjects1});
gdjs.Level3Code.mapOfGDgdjs_46Level3Code_46GDportalObjects1Objects = Hashtable.newFrom({"portal": gdjs.Level3Code.GDportalObjects1});
gdjs.Level3Code.asyncCallback10357988 = function (runtimeScene, asyncObjectsList) {
...
{
const asyncObjectsList = new gdjs.LongLivedObjectsList();
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(2), (runtimeScene) => (gdjs.Level3Code.asyncCallback10357988(runtimeScene, asyncObjectsList)));
}
}
...
{
gdjs.Level3Code.condition1IsTrue_0.val = gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().getFromIndex(0)) == 0;
}}
...
{
gdjs.Level3Code.condition1IsTrue_0.val = gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().getFromIndex(0)) == 1;
}}
if (gdjs.Level3Code.condition1IsTrue_0.val) {
/* Reuse gdjs.Level3Code.GDportalObjects1 */
